 ...
 *
 */
public class Loade_LocalImages {

    private LruCache<String, Bitmap> mMemoryCache;
    private static Loade_LocalImages mInstance = new Loade_LocalImages();
    private ExecutorService mImageThreadPool = Executors.newFixedThreadPool(1);

    private Loade_LocalImages(){
        //获取应用程序的最大内存
     ...
     * @return
     */
    public static Loade_LocalImages getInstance(){
        return mInstance;
    }
